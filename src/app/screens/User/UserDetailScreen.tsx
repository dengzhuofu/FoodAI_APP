...
const styles = StyleSheet.create({
  ...
  headerWrap: { backgroundColor: '#FAFAF7' },
  topBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  topTitle: { flex: 1, textAlign: 'center', fontSize: 16, fontWeight: '900', color: '#111' },
  profileCard: {
    marginHorizontal: 14,
    padding: 14,
    borderRadius: 18,
  ...
  avatar: { width: 74, height: 74, borderRadius: 20, backgroundColor: '#EEE', borderWidth: 1, borderColor: 'rgba(17,17,17,0.08)' },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  nickname: { flex: 1, fontSize: 18, fontWeight: '900', color: '#111' },
  uidPill: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: '#111' },
  uidText: { fontSize: 11, fontWeight: '900', color: '#FFF' },
  ...
  statDivider: { width: 1, height: 26, backgroundColor: 'rgba(17,17,17,0.08)' },
  ...
  primaryBtnSolid: { backgroundColor: '#111', ...theme.shadows.sm },
  primaryBtnGhost: { backgroundColor: '#FFF', borderWidth: 1, borderColor: 'rgba(17,17,17,0.14)' },
